...
function Header() {
  ...
  <div class="w-[calc(100%-230px)] h-full pl-30 flex justify-start items-center bg-transparent">
    <div class="w-full flex justify-start items-center">
      ...
      <div class="mx-2 p-2 pointer-events-none rounded-lg"> 
      ${searchIcon}
      </div>
      <input type="text" class="search outline-none w-full bg-transparent text-white placeholder-white/40 px-3 py-2 z-10" placeholder="Tìm bài hát, đĩa nhạc, nghệ sĩ, podcast">
    </div>
    </div>
