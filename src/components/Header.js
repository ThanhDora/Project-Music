...
async function Header() {
  ...
  <header id="header"
    ...
    <div class="w-[230px] h-full flex justify-start items-center bg-black">
      <div class="px-5 flex gap-8 justify-start items-center">
        <div class="cursor-pointer">${barsIcon}</div>
        <img src="/src/assets/images/logo.svg" alt="logo" class="logo cursor-pointer">
      </div>
    </div>
    <div class="w-[calc(100%-230px)] h-full pl-[10%] flex justify-start items-center bg-transparent">
      <div class="w-full flex justify-start items-center relative">
        <div
          ...
          <div id="search-results" class="absolute top-full left-0 right-0 mt-2 bg-[#212121] rounded-lg shadow-2xl max-h-96 overflow-y-auto z-[100] hidden border border-white/10">
